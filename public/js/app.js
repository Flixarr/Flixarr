...
/******/ 	return __nested_webpack_require_537__(__nested_webpack_require_537__.s = 0);
/******/ })
/************************************************************************/
/******/ ([
/* 0 */
/***/ (function(module, __webpack_exports__, __nested_webpack_require_4013__) {

"use strict";
__nested_webpack_require_4013__.r(__webpack_exports__);
/**
...
/* harmony import */ var _splidejs_splide_extension_url_hash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @splidejs/splide-extension-url-hash */ "./node_modules/@splidejs/splide-extension-url-hash/dist/js/splide-extension-url-hash.esm.js");
/* harmony import */ var _splidejs_splide_extension_url_hash__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_splidejs_splide_extension_url_hash__WEBPACK_IMPORTED_MODULE_1__);
...
window.addEventListener('createMediaBackdropSlider', function (event) {
  var divId = event.detail.divId;
  var options = event.detail.options;
  var media = event.detail.media;
  var splide = new (_splidejs_splide__WEBPACK_IMPORTED_MODULE_0___default())(divId, options).mount();
  media.forEach(function (item) {
    var backdrop_path = item.backdrop_path;
    var title = item.title || item.name;
    var date = item.release_date || item.first_air_date || '0000';
    splide.add('' + '<li class="splide__slide rounded-lg overflow-hidden"> ' + '<div class="relative h-full w-full">' + '<img class="h-auto w-full" src="https://image.tmdb.org/t/p/w500' + backdrop_path + '" />' + '<div class="absolute bottom-0 top-0 flex flex-col justify-end w-full p-2 leading-4 bg-gradient-to-t via-transparent from-black">' + '<span class="font-bold text-gray-500 text-2xs">' + date.substring(0, 4) + '</span>' + '<span class="font-bold truncate">' + title + '</span>' + '</div>' + '' + '' + '</div>' + '</li>' + '');
  });
});
