...
class Plex extends Model
{
     ...
     * Authentication
     *
     * Below are functions associated with Plex Setup
     */
    ...
    /**
     * Generates and returns a Plex Auth Pin
     */
    ...
    // todo: need to see if this gets ONLY user owned servers, 
    public function getUserOwnedServer()
    {
