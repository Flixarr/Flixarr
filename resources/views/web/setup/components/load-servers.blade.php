<div class="" wire:init="loadServers">
    ...
    <div x-data="serverDropdown()" wire:loading.remove wire:target="loadServers" class="space-y-6">
        <div class="space-y-1">
            <div wire:click="loadServers" class="text-xs text-gray-500 text-right">
                <button class="focus:outline-none">Refresh server list</button>
            </div>
                        ...
                        <div wire:loading.delay.remove wire:target="setSelectedServer" class="flex flex-col block truncate text-white">
                            ...
                            @else
                                <div class="flex flex-col tablet:flex-row tablet:items-center tablet:space-x-2 font-normal ml-5 block truncate text-left text-white w-full">
                                    ...
                                    <span class="text-xs text-gray-500 tablet:mt-px">
