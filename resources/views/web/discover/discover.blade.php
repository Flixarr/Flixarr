    ...
    <div class="container mx-auto px-4">
        <div class="bg-gray-800 p-4 rounded">
            <div class="flex justify-between items-center space-x-4">
                ...
                <div class="flex">
                    <svg class="h-7 w-7 text-muted hover:text-white cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-3 laptop:grid-cols-5 desktop:grid-cols-6 grid-flow-row gap-4">
            ...
            @foreach ($media['results'] as $item)
                ...
                <div class="space-y-2">
                    <div>
                        <img class="rounded" src="https://image.tmdb.org/t/p/w220_and_h330_face{{ $item['poster_path'] }}" loading="lazy">
                    </div>
                    <div class="w-full text-xs space-y-1 laptop:space-y-2">
                        ...
                        <div class="w-full tablet:flex justify-between">
                            <div class="text-muted font-semibold">{{ Str::substr($item['release_date'] ?? $item['first_air_date'], 0, 4) }}</div>
